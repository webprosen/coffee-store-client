...
const AddCoffee = () => {
    ...
    return (
        <div className='max-w-7xl mx-auto px-8 pb-20'>
            <h2 className='text-center text-3xl font-bold mt-5'>Add a Coffee</h2>
            <form onSubmit={handleAddCoffee} className='mt-10' action="">
                <div className='flex'>
                ...
                <input className='btn w-[200px] mt-5' type="submit" value="Add Coffee" />
            </form>
        </div>
    );
};
